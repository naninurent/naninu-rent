...
@section('content')
<div class="container">
    <form action="{{url('registCustomer')}}" method="POST" enctype="multipart/form-data">
        <div class="row pt-5">
            <div class="col-md-6">
                @csrf
                <div class="form-group mb-3">
                    <input type="text" class="d-none" name="car_id" value="{{$car->id}}">
                    <label for="nik" class="form-label">NIK</label>
                    <input type="text" name="nik" id="nik" class="form-control" value="{{$customer['ktp']}}" required>
                </div>
                <div class="form-group mb-3">
